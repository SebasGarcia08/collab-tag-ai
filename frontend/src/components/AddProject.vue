<template>
    <form @submit="onSubmit" action="" class="w-1/3 space-y-5">
        ...
        <div>
          ...
          <input
            type="text" v-model="project_name" name="project_name" placeholder="Add project name"
        ...
        <div>
          ...
          <textarea
            cols="30" rows="4" v-model="description" name="description" placeholder="Add description"
            class="block w-full p-2 rounded border-2 border-solid border-gray-500"
          />
        </div>
        <!-- Submit Button -->
